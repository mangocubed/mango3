...
use mango3_leptos_utils::components::{
    ActionFormAlert, CurrentUser, InfiniteScroll, SubmitButton, TextareaField, TimeAgo, UserTag,
};
            ...
            <Show when=move || {
            ...
            }>
                {
                    ...
                    move || {
                        ...
                        let post_comments_resource = Resource::new_blocking(
                            {
                                let post_id = post_id.clone();
                                    ...
                                    async move {
                                        view! {
                                                        ...
                                                        >
                                                            <ActionFormAlert
                                                                ...
                                                                on_success=move || {
                                                                    ...
                                                                    nodes.set(vec![]);
                                                                    after.set(None);
                                                                    post_comments_resource.refetch();
                                                                }
                                            ...
                                            <InfiniteScroll
                                                ...
                                                nodes=nodes
                                                resource=post_comments_resource
                                                let:post_comment
                                            >
